 ...
 */
final class Version20240614105716 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movie_character ADD character_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_AFB9321136BE75');
        $this->addSql('ALTER TABLE movie_character DROP character_id');
    }
}
